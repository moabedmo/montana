...
const socialHandler = require('./api/settings/social');
const geminiSettingsHandler = require('./api/settings/gemini');
const chatSettingsHandler = require('./api/settings/chat');
const geminiChatHandler = require('./api/chat/gemini');
const chatAiHandler = require('./api/chat/ai');
const shippingSettingsHandler = require('./api/settings/shipping');
const shippingCalculateHandler = require('./api/shipping/calculate');
const shippingCreateHandler = require('./api/shipping/create');
const shippingTrackHandler = require('./api/shipping/track');
const metaWebhookHandler = require('./api/webhooks/meta');
const sendMessageHandler = require('./api/messages/social');
const telegramSendHandler = require('./api/telegram/send');
const refreshTokensHandler = require('./api/cron/refresh-tokens');
