...
const AR = {
  ...
  codSub: 'كاش عند الاستلام — بدون مقدّم',
  ...
  returningCustomer: 'مرحباً بعودتك{name}! طلبتي قبل كده {count} مرة',
  returningPointsOnly: 'لقينا رصيد نقاط على الرقم ده',
  phoneLookupHint: 'اكتبي رقم موبايلك عشان نعرّف طلباتك ونقاطك',
  pointsPh: '10, 20, 30…',
  ...
  uploadProof: 'من فضلك ارفع صورة إيصال التحويل',
