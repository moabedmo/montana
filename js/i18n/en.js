...
export const UI_STRINGS = {
  ...
  shop: {
    ...
    products: 'products',
    trustShipping: 'Free shipping over 500 EGP',
  ...
  checkout: {
    ...
    codSub: '200 EGP deposit + remainder in cash on delivery',
    ...
    depositCod:
      'Transfer {amount} EGP as a booking deposit via InstaPay or mobile wallet, then upload a screenshot (remainder in cash on delivery):',
    ...
    uploadProof: 'Please upload a transfer receipt to confirm your booking',
  ...
  confirmation: {
    ...
    awaitingBooking: 'Awaiting booking confirmation',
