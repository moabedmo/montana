...
(function() {
    ...
    const COPY = IS_EN
        ? {
            ...
            proofPending: (order) => `Your order ${order} is registered. Upload your transfer receipt (200 EGP deposit) below 👇`,
            namePh: 'Full name',
        ...
        : {
            ...
            proofPending: (order) => `طلبك \`${order}\` اتسجّل ✅ حوّلي مقدّم 200 ج.م وارفعي صورة الإيصال هنا 👇`,
